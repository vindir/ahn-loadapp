...
Adhearsion.config do |config|
  ...
  config.punchblock.username = "YourAMIUser" # Your AMI username
  config.punchblock.password = "YourAMIPassword" # Your AMI password
  config.punchblock.host = "your.asterisk.hostname" # Your AMI host
